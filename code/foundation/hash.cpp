...
__forceinline unsigned int xcrc32( const unsigned char *buf, int len, unsigned int init )
{
...
{
    const unsigned len = (unsigned)strlen( data );
    return crc32n( (unsigned char*)data, len, init );
}
unsigned crc32n( const unsigned char* data, unsigned len, unsigned init )
{
    return xcrc32( data, len, init );
}
